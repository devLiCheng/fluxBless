...
function RichTextEditor({ value = '', onChange }: { value?: string; onChange?: (val: string) => void }) {
  ...
  const handleInsertTable = () => {
    const tableHtml = `<table style="width: 100%; border-collapse: collapse; margin: 12px 0;"><thead><tr><th style="border: 1px solid var(--color-border); padding: 8px; background: var(--color-fill-2); font-weight: bold; text-align: left;">特征/参数</th><th style="border: 1px solid var(--color-border); padding: 8px; background: var(--color-fill-2); font-weight: bold; text-align: left;">详细说明</th></tr></thead><tbody><tr><td style="border: 1px solid var(--color-border); padding: 8px;">单元格1</td><td style="border: 1px solid var(--color-border); padding: 8px;">单元格2</td></tr><tr><td style="border: 1px solid var(--color-border); padding: 8px;">单元格3</td><td style="border: 1px solid var(--color-border); padding: 8px;">单元格4</td></tr></tbody></table><p><br></p>`;
